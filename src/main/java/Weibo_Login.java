...
public class Weibo_Login {
    public static void main(String[] args) throws Exception{
        ...
        //等待输入框可用后输入账号密码
        webDriverWait.until(ExpectedConditions.elementToBeClickable(By.id("loginName"))).sendKeys("13558714741");
        webDriverWait.until(ExpectedConditions.elementToBeClickable(By.id("loginPassword"))).sendKeys("wallace1991wjm");
        //点击登录
